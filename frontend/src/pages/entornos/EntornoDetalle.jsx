        ...
        <div className="space-y-6 pb-10">
            ...
            <div className="space-y-4">
                ...
                {(entorno.cortes || []).length === 0 && !addingCorte && (
                    <p className="text-slate-400 text-sm text-center py-8">Sin cortes. Agrega el primero.</p>
                )}
                ...
                {!addingCorte && (
                    <button onClick={() => setAddingCorte(true)}
                        className="w-full flex items-center justify-center gap-2 py-3 rounded-2xl text-sm font-semibold border-2 border-dashed transition-all hover:opacity-80"
