...
// Listado principal de Entornos Académicos (reemplazando Cohortes/Grupos).
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                <div>
                    <div className="flex items-center gap-2 mb-1">
                        <h1 className="text-2xl font-bold text-slate-800">Entornos Académicos</h1>
                    ...
                    <p className="text-slate-500 text-sm">Organiza tus grupos de AGON y gestiona tus entregables y calificaciones por semestre</p>
                </div>
