...
function getColor(valor) {
    return NIVEL_COLORS[valor] || { color:'#64748b', bg:'#f1f5f9', label:`Nivel ${valor}` };
}

export default function RubricaGrid({ criterios, scores, onScore }) {
    if (!criterios?.length) return null;

    // Recolectar todos los valores únicos de nivel existentes en la rúbrica
    ...
    // Promedio total solo de criterios ya calificados
